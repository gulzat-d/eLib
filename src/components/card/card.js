...
export class Card extends DivComponent {
  ...
  #deleteFromFavorites() {
    ...
    this.el.innerHTML = `
        <div class="card__img">
          <img 
            src="https://covers.openlibrary.org/b/id/${this.cardState.cover_i}-M.jpg" 
            alt="Обложка книги">
        </div>
        <div class="card__info">
          ...
          <div class="card__footer">
            <button 
              class="button__add ${existInFavorites ? 'button__active' : ''}"
            >
              ${existInFavorites
                  ? '<img src="static/favorites.svg" alt="Удалить из избранного">' 
                  : '<img src="static/favorites-white.svg" alt="Сохранить в избранное">'
              }
            </button>
          </div>
        </div>
